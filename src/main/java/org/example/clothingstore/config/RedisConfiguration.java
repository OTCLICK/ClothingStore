...
public class RedisConfiguration {
    ...
    public RedisCacheManager cacheManager() {
        ...
        return RedisCacheManager.builder(redisConnectionFactory())
                ...
                .withCacheConfiguration("clothingCategories", myDefaultCacheConfig(Duration.ofMinutes(10)))
                .withCacheConfiguration("discountCoupons", myDefaultCacheConfig(Duration.ofMinutes(10)))
                .withCacheConfiguration("orders", myDefaultCacheConfig(Duration.ofMinutes(10)))
                .withCacheConfiguration("products", myDefaultCacheConfig(Duration.ofMinutes(10)))
